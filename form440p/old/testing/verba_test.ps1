...
[string]$logName440 = "$dir1\log\" + $curDate +"_f440-test.log"
...
Write-Log -EntryType Information "Функция Verba_script с использованием sql"
copyXML
$startDTM = (Get-Date)
Verba_script_sql -scrpt_name $script_sig -mask "*.*"
Write-Log -EntryType Warning "Elapsed Time: $(($(Get-Date)-$startDTM).totalseconds) seconds"
