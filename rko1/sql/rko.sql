...
select DISTINCT a.divname "№ Д/О",c.accname "Наименование счета",c.newaccnum "Номер счета",
b.summa "Сумма комиссии" 
from division a,rsperc b,accounts c
where b.calcdate = to_date('&date_rko', 'dd.mm.yyyy')
and c.accnum=b.account and c.currcode='000'
and b.opernum>25704
